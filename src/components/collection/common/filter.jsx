...
class Filter extends Component {
    ...
    filterPrice = (val) => {
        ...
        if(this.props.history.location.search)
            keyword = this.props.history.location.search.toLowerCase().split('keyword=')[1]
        let keywordString = ''
        if(keyword)
            keywordString = '&keyword='+ keyword
        this.props.history.push(this.props.history.location.pathname+'?price='+val.value.min+'-'+val.value.max + keywordString)
    }
                                    ...
                                    <div className="collection-brand-filter">
                                        <div className="custom-control custom-checkbox collection-filter-checkbox">
                                            <InputRange
                                                ...
                                                onChange={value => this.filterPrice({ value })} />
                                        </div>
                                    </div>
                                </div>
                            </div>
